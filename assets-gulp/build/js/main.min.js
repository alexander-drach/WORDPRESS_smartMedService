...
var _menu = require("./modules/mobile-menu/menu");
var _slider = require("./modules/slider/slider");
var _adminToolbar = require("./modules/admin-toolbal/admin-toolbar.js");
// ---------------------------------
...
},{"./modules/admin-toolbal/admin-toolbar.js":2,"./modules/form-validate/form":4,"./modules/mobile-menu/menu":10,"./modules/modals/init-modals":11,"./modules/slider/slider":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.adminToolbar = void 0;
var adminToolbar = exports.adminToolbar = function adminToolbar() {
  ...
  anchors.forEach(function (anchor) {
    anchor.addEventListener("click", function (e) {
      ...
      e.preventDefault();
      var $blockTo = document.getElementById(this.getAttribute('href').substr(1));
      window.scrollTo({
        top: $blockTo.offsetTop - 130,
        behavior: "smooth"
      });
    });
  });
...
var openMenu = exports.openMenu = function openMenu() {
  ...
  var mobileMenuItems = document.querySelectorAll('.header .nav a');
